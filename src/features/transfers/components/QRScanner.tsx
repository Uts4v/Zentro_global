...
export function QRScanner({ onScan, onClose }: QRScannerProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 p-4">
      <div className="relative w-full max-w-sm rounded-2xl bg-card dark:bg-white/5 p-4">
        <button
          onClick={onClose}
          className="absolute -right-2 -top-2 grid h-8 w-8 place-items-center rounded-full bg-card dark:bg-white/5 shadow-md"
        >
          <X className="h-4 w-4" />
        </button>
